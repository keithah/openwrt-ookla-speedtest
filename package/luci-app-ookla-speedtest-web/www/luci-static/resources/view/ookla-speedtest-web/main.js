...
'require view';
'require rpc';
var specs={status:[],servers:[],start:['server_id'],history:[],delete_history:['id'],clear_history:[],settings:[],accept_terms:[],local_download:['bytes'],local_upload:['data'],record_local:['download_mbps','upload_mbps','ping_ms']};
var call={};
