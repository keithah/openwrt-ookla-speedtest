...
'require view';
'require rpc';
var specs={status:[],servers:[],network_info:[],start:['server_id'],start_live:['server_id'],live_status:['job_id'],cancel_live:['job_id'],history:[],delete_history:['id'],clear_history:[],settings:[],save_settings:['default_mode','server_id','history_retention','motion','schedule_hours'],accept_terms:[],begin_local:[],cancel_local:['run_id'],local_download:['run_id','bytes'],local_upload:['run_id','data'],record_local:['run_id','download_mbps','upload_mbps','ping_ms']};
var call={};
...
return view.extend({
 ...
 render:function(){
  ...
  frame.addEventListener('load',function(){try{frame.contentWindow.SpeedtestWebAdapter=bridge}catch(e){}});
