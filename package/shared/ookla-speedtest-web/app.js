...
function saveSettings(changes){return checked('save_settings',changes).then(function(settings){applySettings(settings);render();notify();return settings})}
